...
-(void)pagesCell:(REDBookPagesCell *)pagesCell didChangeBookPages:(NSUInteger)pages {
    [Localytics tagEvent:@"Page Progress" attributes:@{@"pages" : [NSString stringWithFormat:@"%lu", pages]}];
...
-(void)pageProgressCell:(REDPageProgressCell *)cell didCompleteBookReading:(id<REDBookProtocol>)book {
    [Localytics tagEvent:@"Completed Book" attributes:@{@"pages" : [NSString stringWithFormat:@"%lu", [book pagesValue]], @"book" : [book name]}];
