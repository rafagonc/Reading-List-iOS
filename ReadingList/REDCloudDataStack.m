...
-(NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    if (![_persistentStoreCoordinator addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:@{NSPersistentStoreUbiquitousContentNameKey: @"ReadingList"} error:&error]) {
